...
#region readme
//  Add to PlayerMobile.cs if using ServUO, Player.cs if using Ulmeta
...
namespace Ulmeta.Factions
{
    ...
    public class   FactionDefinition
    {
        ...
        public static int FactionLimit = 11; //Should be set according to machine capability.
    ...
    public class      FactionHandler
    {
        ...
        public static void AttemptPact(SpeechEventArgs e)
        {
            if (e.Mobile is PlayerMobile && ((PlayerMobile)e.Mobile).CurrentFaction == null)
            {
                e.Mobile.SendMessage
                    ("You must be the leader of a faction to form pacts with other guilds.");
                return;
            }
            ...
            else e.Mobile.SendMessage("You must be the leader of a faction to form pacts with other guilds.");
        }
        ...
        public static void AttemptInitialization(SpeechEventArgs e)
        {
            ...
            if (c == null)
            {
                caller.SendMessage("You must have a bank account to form a faction..");
                return;
            }
            ...
            else caller.SendMessage("You are already in a faction!");
        }
        ...
        public static void CheckLeader(SpeechEventArgs e)
        {
            ...
            if (caller.CurrentFaction == null)
            {
                caller.SendMessage("You are not in a faction.");
                return;
            }
        ...
        public static void QueryGuild(PlayerMobile m)
        {
            ...
            {
                m.SendMessage("You must be a guild leader to form a faction.");
                return;
            }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (from.AccessLevel == AccessLevel.Player && RegionArea != null)
            {
                if (Home() && from.InRange((IPoint2D)this.Location, 1))
                {
                    ...
                    {
                        from.SendMessage("You must be in a faction to capture this sigillum");
                        return;
                    }
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
                ...
                !String.IsNullOrEmpty(info.GetTextEntry((int)Buttons.TextEntry).Text))
            {
                    ...
                    || caller.AccessLevel > AccessLevel.Player))
                {
                    ...
                    sender.Mobile.SendMessage("Your bank account must contain {0} gold to form a faction.", cost );
                    return;
                }
    ...
    public class JoinFactionQuery  : Gump
    {
            ...
            : base(80, 80)
        {
            ...
            this.AddHtml(104, 85, 284, 45, m.Name + @" Is inviting you to join a faction. Do you accept?", true, true);
    ...
    public class FactionTrapKit : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else from.SendMessage("You must be in a faction to use this item.");
        }
...
namespace Ulmeta.Factions.Vendors
{
    ...
    public class HorseBreeder    : FactionVendor
    {
        ...
        public void BeginStable(Mobile from)
        {
            ...
            {
                SayTo(from, true, "I charge 30 gold per pet for a real week's stable time. I will withdraw it from thy bank account. Which animal wouldst thou like to stable here?");
